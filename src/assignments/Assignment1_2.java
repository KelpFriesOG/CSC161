...
public class Assignment1_2 {
	...
	public static void main(String[] args) {
		...
		// Calculation to first convert feet and inches to total inches, and then convert inches to meters
		...
		// Source for ranges https://www.nhs.uk/common-health-questions/lifestyle/what-is-the-body-mass-index-bmi/
		...
		// Printing out msg variable which contains the appropriate value based on the categorization.
